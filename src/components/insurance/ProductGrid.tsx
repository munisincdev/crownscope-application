  ...
  return (
    <div className="grid grid-cols-3 gap-6">
      <button
        ...
        className="flex flex-col items-center justify-center gap-4 py-2 group col-span-1"
      ...
      >
        ...
        <span className="text-xs tracking-wide text-gray-700 text-center leading-relaxed min-h-[2.5rem] group-hover:text-primary whitespace-pre-line font-sans">
          {products[0].label}
        </span>
      </button>
      ...
      <button
        ...
        className="flex flex-col items-center justify-center gap-4 py-2 group"
      ...
      <button
        ...
        className="flex flex-col items-center justify-center gap-4 py-2 group col-start-2"
